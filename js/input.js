...
const _chaosBtn = document.getElementById('chaosBtn');
if (_chaosBtn) {
  _chaosBtn.addEventListener('click', () => {
    chaosMode = !chaosMode;
    _chaosBtn.textContent = chaosMode ? 'Chaos ON' : 'Chaos OFF';
    _chaosBtn.classList.toggle('on', chaosMode);
  });
}
...
const _fuzzyBtn = document.getElementById('fuzzyBtn');
if (_fuzzyBtn) {
  _fuzzyBtn.addEventListener('click', () => {
